    ...
    <div class="desc">
      ...
      <a href="#">
        <div class="user-info">
          ...
          <div class="timestamp">2017-06-20 15:48:37</div>
        </div>
      </a>
    </div>
    <div class="article-card" v-if="mold === 'quote'">
      <div class="title">豆瓣App 4.12.0 主要更新</div>
      <div class="detail">
        - 可以写读书笔记了，同时支持编辑。随时随地，摘录怦然心动的段落，写下阅读时的随感。来写笔记吧，你...
      </div>
    </div>
    <p class="comment" v-if="mold === 'comment'">
      可以写读书笔记了，同时支持编辑。随时随地，摘录怦然心动的段落，写下阅读时的随感。来写笔记吧，你
    </p>
    <div class="info">
      <span class="btn lick"><i>4</i></span>
      <span class="btn comment" v-if="mold === 'quote'"><i>0</i></span>
      <span class="btn retweet" v-if="mold === 'quote'"><i>1</i></span>
